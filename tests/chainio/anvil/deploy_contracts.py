...
EIGENLAYER_DIR = os.path.abspath(os.path.join(
...
try:
    ...
    print("Failed to compile contracts. Make sure Foundry is installed and the contracts can be compiled.")
    exit(1)
...
try:
    ...
    print("   ANVIL_RUNNING=1 CONTRACTS_DEPLOYED=1 pytest -xvs tests/ChainIO/Anvil/test_with_anvil.py")
