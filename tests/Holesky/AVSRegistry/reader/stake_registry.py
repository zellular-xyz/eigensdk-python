...
def test_get_total_stake_at_block_number_from_index():
    ...
    block_number = holesky_avs_registry_reader.eth_client.eth.block_number  # Use current block number
...
def test_weight_of_operator_for_quorum():
    ...
    return holesky_avs_registry_reader.weight_of_operator_for_quorum(call_options, quorum_number, operator_addr)
